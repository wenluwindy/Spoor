...
- **Research Lab** — 把研究问题拆成计划，收集资料，生成报告，再沉淀回画布；报告可以**整块落到画布**，题目、计划、论点、结论各成一张卡并圈进一个区域框。
...
- 发布说明：[v0.3.1](docs/release/RELEASE_v0.3.1.md) · [v0.3.0](docs/release/RELEASE_v0.3.0.md) · [v0.2.0](docs/release/RELEASE_v0.2.0.md) · [v0.1.0](docs/release/RELEASE_v0.1.0.md)
