import { FileText, Film, Frame, Globe, Image as ImageIcon, Plus, Sparkles, Wand2 } from 'lucide-react';
...
export interface CanvasCreateItemDef {
  id: 'note' | 'theme' | 'imagegen' | 'web' | 'frame';
  /**
