...
export const en = {
  ...
  "settings": {
    ...
    "ccswitch_hint": "Pick cc-switch's config.json (usually at <home>\\.cc-switch\\config.json). Claude and Codex services that carry a key are appended; nothing you already configured is overwritten.",
    "ccswitch_result": "Imported {{added}} service(s). {{duplicates}} duplicate(s) skipped, {{skipped}} entr(ies) had no key to import.",
    "ccswitch_none": "Could not find any keyed service in that file. Check that it is cc-switch's config.json.",
    "ccswitch_bad_json": "That file is not valid JSON.",
