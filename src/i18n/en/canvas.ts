export const canvas = {
  ...
  "mirror_report_title": "Note file sync",
  "organize_preview": "AI grouping preview: {{groups}} groups, {{moved}} cards to move",
  "organize_apply": "Apply",
  "organize_cancel": "Cancel",
  "organize_failed": "AI grouping failed",
  "organize_parse_failed": "Could not parse the AI grouping result, please retry",
  "mirror_imported": "Restored canvases from files: {{names}}",
  "mirror_merged": "\"{{name}}\" merged external changes ({{added}} added, {{updated}} updated)",
  "mirror_foreign": "Unrecognized files in the notes folder (possibly sync conflict copies), please review: {{names}}",
  ...
  "menu": {
    ...
    "set_tags": "Tags…",
    "organize_selected": "AI group & organize ({{count}} cards)…",
    "relay_to_agent": "Hand off to a persona",
    "align": "Align",
    ...
    "rename_template_title": "Rename template",
    "rename_template_placeholder": "New template name",
  ...
  "tags": {
    ...
    "rename": "Rename…",
    "rename_title": "Rename tag \"{{tag}}\"",
    "rename_placeholder": "New tag name",
  ...
  "presentation": {
    "start": "Present",
    "start_here": "Present from here",
    "empty": "This canvas has nothing to present.",
    "position": "{{index}}/{{total}}",
    "prev": "Previous card (←)",
    "next": "Next card (→ / Space)",
    "exit": "Exit presentation (Esc)",
    "order": "Adjust order",
    "order_title": "Playback order",
    "jump_to": "Jump to this card",
    "move_up": "Move up",
    "move_down": "Move down",
    "apply_order": "Apply",
    "cancel_order": "Cancel",
    "untitled": "(untitled card)",
    "blank_click_hint": "Click empty canvas to advance · arrow keys to navigate · Esc to exit"
  }
};
